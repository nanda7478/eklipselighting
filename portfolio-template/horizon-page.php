...
<input checked="checked" name="Model" value="H" type="radio">Horizon
</div>
</div>
...
<div class="order_option_second">
<input name="Film" value="CU" type="radio">Custom
</div>
</div>
...
<br>
<input name="Model_name" value="Horizon" type="hidden">
