<?php
/*
  Display Template Name: Horizon V
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="HV" type="radio">Horizon V
</div>
</div>
...
<div class="order_option_second">
<input name="WattageFoot" value="4.5W" type="radio">4.5 W / feet 
</div>
<div class="order_option_second">
<input name="WattageFoot" value="5W" type="radio">5 W / feet
</div>
<div class="order_option_second">
...
<div class="order_option_second">
<input name="WattageFoot" value="7.5W" type="radio">7.5 W / feoot
</div>
<div class="order_option_second">
...
<div class="order_option" id="Diffuser">
<label>Diffuser
</label>
<div class="order_option_second">
<input name="Diffuser" value="SD" type="radio">Shape Diffuser
</div>
</div>
...
<br>
<input name="Model_name" value="Horizon V" type="hidden">
