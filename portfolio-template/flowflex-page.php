<?php
/*
  Display Template Name: Flow Flex
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="FF" type="radio">Flow Flex
</div>
</div>
...
<div class="order_option_second">
<input name="Application" value="U" type="radio">Uplight
</div>
<div class="order_option_second">
<input name="Application" value="D" type="radio">Downlight
</div>
</div>
...
<br>
<input name="Model_name" value="Flow Flex" type="hidden">
