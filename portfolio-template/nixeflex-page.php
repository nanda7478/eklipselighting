<?php
/*
  Display Template Name: Nixe Flex
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="NF" type="radio">Nixe Flex
</div>
</div>
...
<div class="order_option_second">
<input name="Wattage / Foot" value="6.5W" type="radio">6.5 W / foot
</div>
</div>
...
<div class="order_option" id="MinimumRadiusCurve">
<label>Minimum Radius Curve
</label>
<br>
<select name="MinimumRadiusCurve">
<option value="3in_min_radius">3in_min_radius</option>
<option value="6in_min_radius">6in_min_radius</option>
<option value="9in_min_radius">9in_min_radius</option>
<option value="12in_min_radius">12in_min_radius</option>
<option value="15in_min_radius">15in_min_radius</option>
<option value="18in_min_radius">18in_min_radius</option>
<option value="21in_min_radius">21in_min_radius</option>
<option value="24in_min_radius">24in_min_radius</option>
</select>
</div>
...
<div class="order_option_second">
<input name="Optics" value="20°C" type="radio">20° Clear
</div>
<div class="order_option_second">
<input name="Optics" value="40°SD" type="radio">40° Semi-diffused
</div>
<div class="order_option_second">
<input name="Optics" value="70°D" type="radio">70° Diffused
</div>
<div class="order_option_second">
<input name="Optics" value="WD" type="radio">Wide Diffused
</div>
<div class="order_option_second">
<input name="Optics" value="AD" type="radio">Asymmetric Diffused
</div>
</div>
...
<div class="order_option_second">
<input name="Film" value="N/A" type="radio">None
</div>
</div>
...
<br>
<input name="Model_name" value="Nixe Flex" type="hidden">
