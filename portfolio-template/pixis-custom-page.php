<?php
/*
  Display Template Name: Pixis Custom
*/
get_header();
?>
<?php
...
<form action="" method="POST" id="order_form"> 
 ...
 <input checked="checked" name="Model" value="PC" type="radio">Pixis Custom</div>
 </div>
 ...
 <div class="order_option" id="Heads">
 <label>Heads</label>
 <div class="order_option_second">
 <input name="Heads" value="1H" type="radio">One head</div>
 <div class="order_option_second">
 <input name="Heads" value="2H" type="radio">Two heads</div>
 <div class="order_option_second">
 <input name="Heads" value="3H" type="radio">Three heads</div>
 <div class="order_option_second">
 <input name="Heads" value="4H" type="radio">Four heads</div>
 <div class="order_option_second">
 <input name="Heads" value="5H" type="radio">Five heads</div>
 </div>

 <div class="order_option" id="OverallStemHeight">
 <label>Overall Stem Height</label>
 <div class="order_option_second">
 <input min="1" max="180" style="width:100%;" name="OverallStemHeight" type="number">
 </div>
 </div>
...
<input name="Model_name" value="Pixis Custom" type="hidden">
