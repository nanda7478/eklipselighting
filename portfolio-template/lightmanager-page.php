<?php
/*
  Display Template Name: Light Manager
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="LM" type="radio">Light Manager
</div>
</div>
...
<div class="order_option_second">
<input name="Power" value="60W" type="radio">60 Watts
</div>
<div class="order_option_second">
...
<br>
<input name="Model_name" value="Light Manager" type="hidden">
