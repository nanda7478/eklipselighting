<?php
/*
  Display Template Name: Horizon Wet
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="HW" type="radio">Horizon Wet
</div>
</div>
...
<div class="order_option_second">
<input name="Optics" value="7°" type="radio">7°
</div>
<div class="order_option_second">
<input name="Optics" value="21°" type="radio">21°
</div>
<div class="order_option_second">
<input name="Optics" value="48°" type="radio">48°
</div>
<div class="order_option_second">
<input name="Optics" value="14°x55°" type="radio">14° x 55°
</div>
</div>
...
<br>
<input name="Model_name" value="Horizon Wet" type="hidden">
