<?php
/*
  Display Template Name: Pixis Plugn Play
*/
get_header();
?>
<?php
...
<form action="" method="POST" id="order_form"> 
 ...
 <input checked="checked" name="Model" value="PP" type="radio">Pixis Plug And Play</div>
 </div>
 ...
 <input name="Model_name" value="Pixis Plug And Play" type="hidden">
