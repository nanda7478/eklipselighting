<?php
/*
  Display Template Name: Horizon Mini Flex
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="HMF" type="radio">Horizon Mini Flex
</div>
</div>
...
<div class="order_option_second">
<input name="WattageFoot" value="5.5W" type="radio">5.5 W / feet 
</div>
<div class="order_option_second">
...
<div class="order_option_second">
<input target="Optics" name="LightEngine" value="PB" type="radio">Perfect Blend 
</div>
</div>
...
<div class="order_option_second">
<input name="Segment" value="2in" type="radio">2 inches
</div>
<div class="order_option_second">
...
<div class="order_option_second">
<input name="Optics" value="18°" type="radio">18° 
</div>
<div class="order_option_second">
<input name="Optics" value="25°" type="radio">25° 
</div>
<div class="order_option_second">
<input name="Optics" value="36°" type="radio">36° 
</div>
<div class="order_option_second">
<input name="Optics" value="74°" type="radio">74°
</div>
<div class="order_option_second">
<input name="Optics" value="19°x48°" type="radio">19° x 48° 
</div>
<div class="order_option_second">
...
<br>
<input name="Model_name" value="Horizon Mini Flex" type="hidden">
