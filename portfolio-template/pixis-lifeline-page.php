<?php
/*
  Display Template Name: Pixis Lifeline
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="PL" type="radio">Pixis Lifeline
</div>
</div>
...
<div class="order_option_second">
<input name="WattageHead" value="3W" type="radio">3 W / head</div>
</div>
...
<div class="order_option_second">
<input name="Finish" value="BKC" type="radio">Black</div>
<div class="order_option_second">
...
<input name="Model_name" value="Pixis Lifeline" type="hidden">
