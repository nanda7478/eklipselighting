...
<input checked="checked" name="Model" value="E" type="radio">Edge
</div>
</div>
...
<div class="order_option_second">
<input name="Wattage Foot" value="5.5W" type="radio">5.5 W / foot
</div>
<div class="order_option_second">
...
<div class="order_option_second">
<input name="Finish" value="ABK / W" type="radio">Anodized black Outsite / Painted White Inside
</div>
<div class="order_option_second">
<input name="Finish" value="W / W" type="radio">Painted White Outside / Painted White Inside
</div>
</div>
...
<br>
<input name="Model_name" value="Edge" type="hidden">
