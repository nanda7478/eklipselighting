<?php
/*
  Display Template Name: Horizon Flex
*/
get_header();
?>
<?php
...
<div class="order_code">
		<div class="row">
			<div class="col-lg-12"><form action="" method="POST" id="order_form"> 
<div class="order_option" id="Model">
<label>Model
</label>
<div class="order_option_second">
<input checked="checked" name="Model" value="HF" type="radio">Horizon Flex
</div>
</div>
...
<div class="order_option_second">
<input name="WattageFoot" value="8W" type="radio">8 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="8.5W" type="radio">8.5 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="9W" type="radio">9 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="9.5W" type="radio">9.5 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="10W" type="radio">10 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="10.5W" type="radio">10.5 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="11W" type="radio">11 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="11.5W" type="radio">11.5 W / foot
</div>
<div class="order_option_second">
<input name="WattageFoot" value="12W" type="radio">12 W / foot
</div>
</div>
...
<div class="order_option_second">
<input target="Optics" name="LightEngine" value="F" type="radio">Focus 
</div>
<div class="order_option_second">
<input target="Optics" name="LightEngine" value="W" type="radio">Wide 
</div>
</div>
...
<div class="order_option" id="Segment">
<label>Segment
</label>
<div class="order_option_second">
<input name="Segment" value="4in" type="radio">4 inches
</div>
<div class="order_option_second">
<input name="Segment" value="8in" type="radio">8 inches
</div>
</div>
...
<div class="order_option_second">
<input name="EndCap" value="MIV" type="radio">MIV
</div>
</div>
...
<div class="order_option_second">
<input name="Optics" value="27°" type="radio">27° 
</div>
<div class="order_option_second">
<input name="Optics" value="49°" type="radio">49°
</div>
<div class="order_option_second">
<input name="Optics" value="10°x50°" type="radio">10° x 50° 
</div>
<div class="order_option_second">
...
<div class="order_option_second">
<input name="Film" value="LOF" type="radio">Linear Optical Film 
</div>
<div class="order_option_second">
...
<br>
<input name="Model_name" value="Horizon Flex" type="hidden">
