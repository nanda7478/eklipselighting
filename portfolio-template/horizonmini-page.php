<?php
/*
  Display Template Name: Horizon Mini
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="HM" type="radio">Horizon Mini
</div>
</div>
...
<br> 
<input name="Model_name" value="Horizon Mini" type="hidden">
