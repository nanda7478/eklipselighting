<?php
/*
  Display Template Name: Horizon Contour
*/
get_header();
?>
<?php
...
<input checked="checked" name="Model" value="HC" type="radio">Horizon Contour
</div>
</div>
...
<div class="order_option_second">
<input name="Finish" value="WH" type="radio">Painted white
</div>
<div class="order_option_second">
...
<br>
<input name="Model_name" value="Horizon Contour" type="hidden">
