...
<input checked="checked" name="Model" value="F" type="radio">Flow
</div>
</div>
...
<label>Film</label>
<a href="#" class="ordering_moreinfo"><span><div class="arr"></div><img src="<?php bloginfo('template_url');?>/images/Filtre-Filtre.png">
Frosted filter.
<br>
<img src="<?php bloginfo('template_url');?>/images/Filtre-None.png">
No filter / Clear filter.</span></a>
<div class="order_option_second">
...
<br>   
<input name="Model_name" value="Flow" type="hidden">   
