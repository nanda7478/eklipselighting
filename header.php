...
<head>
   ...
   <link rel="stylesheet" href="<?php bloginfo('template_url');?>/css/jquery.tabs.css"> 
   ...
   <?php if(!is_page('lightingprojects')) { ?>
		...
		<header id="masthead" class="site-header" role="banner">
			<div class="site-header-main">
              <div class="container">
                ...
                <div class="row">
                <div class="col-lg-6 col-7 col-md-6">
				...
				<?php if ( has_nav_menu( 'primary' ) || has_nav_menu( 'social' ) ) : ?>
					...
					<div id="site-header-menu" class="site-header-menu">
						<?php if ( has_nav_menu( 'primary' ) ) : ?>
							<nav id="site-navigation" class="main-navigation1" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'twentysixteen' ); ?>">
								<?php
									wp_nav_menu( array(
